...
class _SignupFormState extends State<SignupForm> {
  ...
  void initState() {
    super.initState();
    passwordController = context.read<SignupCubit>().passwordContoller;
  ...
  Widget build(BuildContext context) {
    return Form(
      key: context.read<SignupCubit>().formkery,
      child: Column(
        children: [
          AppTextFormField(
            hinttext: 'Name',
          ...
          AppTextFormField(
            controller:
                context.read<SignupCubit>().passwordConformationContoller,
          ...
          PasswordValidations(
            ...
            hasspecialcharcater: hasSpecialCharacters,
            hasNumber: hasNumber,
